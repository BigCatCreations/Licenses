...
- Review of the existing venue and its design and functionality
- Proposal of new venue layout, and design elements
- Development of new models, textures, and lighting elements to facilitate a venue re-design and re-master.
- Assemblage of the provided elements into an easy to use Unity repository that can be modified as needed by FBHC in future.
...
Under the below term:
- Attribution -- You must give appropriate credit*, and indicate if changes were made. 


## Definitions
### Appropriate Credit
If supplied in the project by the Licensor, the following must be made easily visible
- Name of the creator
- Handle
- Link to Portfolio
- Description of the work done (For instance: world by..., world concept by..., textures by..., modelling by...) based on content used.
